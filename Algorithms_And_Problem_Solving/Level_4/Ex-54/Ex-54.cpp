...
string FormatDate(stDate Date, string DateFormat = "dd/mm/yyyy")
{
	...
	FormattedDate = ReplaceWordsUsingbuiltInFunction(DateFormat, "dd", to_string(Date.Day));
	FormattedDate = ReplaceWordsUsingbuiltInFunction(FormattedDate, "mm", to_string(Date.Month));
	FormattedDate = ReplaceWordsUsingbuiltInFunction(FormattedDate, "yyyy", to_string(Date.Year));
