...
int main()
{
	...
	short NumberIndex = 0;
	if ((NumberIndex = GetElementIndexInArray<short>(arr, NumberToCheck, arrLength)) != -1)
		cout << "\n" << "the number was found at position : " << NumberIndex << endl;
	else
		cout<<"\nthe number you're looking does'nt exist!"<< endl;
