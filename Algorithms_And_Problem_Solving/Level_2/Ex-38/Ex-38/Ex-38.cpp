...
void CopyOddNumbersFromArray(short ArraySource[], short DestinationArr[], short arrSourceLength, short& arrDestinationLength)
{

	for (short i = 0; i < arrSourceLength; i++)
	{
		if(IsOdd(ArraySource[i]))
		{
...
int main()
{
	...
	CopyOddNumbersFromArray(arr1, arr2, arr1Length, arr2Length);
